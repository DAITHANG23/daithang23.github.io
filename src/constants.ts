...
export const LIST_EXPERIENCES: Array<ListExperiencesType> = [
  {
    ...
    content:
      "• Education & Student Management System which a web – app to support teachers in managing student and accademic performance. The app is built using Typescript, Nextjs, Supabase, Material UI, PostgreSQL, host on Vercel.",
  },
  {
